...
const BestWriter = () => {
    return (
        <div className="md:container justify-center flex">
            <div className="flex flex-col duration-1000 hover:scale-105 justify-center max-w-xs p-6 shadow-md rounded-xl sm:px-12 bg-gray-900 text-gray-100">
                <img src="https://i.ibb.co/DQRWjhC/1646194661484.png" alt="" className=" mx-auto rounded-full bg-gray-500 aspect-square" />
                <div className="space-y-4 text-center divide-y divide-gray-700">
                    <div className="my-2 space-y-1">
                        <h2 className="text-xl font-semibold sm:text-2xl">Jhankar Mahbub</h2>
                        <p className="px-5 text-xs sm:text-base text-gray-400">Best Writer in 2024</p>
                        <p>Books Name : Growing-Through-Struggle</p>
                    </div>
